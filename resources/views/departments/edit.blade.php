        ...
        <div class="container-fluid col-md-12">
            <div class="card card-outline-success" style="width:81vw;">
                <div class="card-header">
                    <h4 class="m-b-0 text-white"> Update Department</h4>
                </div>
                <div class="card-body">
                    ...
                    {!! Form::model($departments,['method'=>'PATCH','action'=>['DepartmentController@update',$departments->id]]) !!}
                    ...
                    <div class="form-group">
                        {!! Form::submit('Update Department',['class'=>'btn btn-info']) !!}
